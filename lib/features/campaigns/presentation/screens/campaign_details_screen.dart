  ...
  Future<void> _loadDetails() async {
    ...
    try {
      ...
      if (mounted) {
        setState(() {
          _isLoading = false;
          _errorMessage = 'Unable to load campaign details. Please check your connection and try again.';
        });
      }
    }
  }
        ...
        body: const Center(
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 16),
              Text('Loading campaign details...', style: TextStyle(color: Colors.grey, fontSize: 13)),
            ],
          ),
        ),
      );
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  _errorMessage ?? 'Unable to retrieve campaign details.',
                      ...
                      return InkWell(
                        ...
                        onTap: () {
                          CelebrationDialog.showCampaignMilestone(
                            ...
                            currentDistanceKm: campaign.userDistanceKm,
                            targetDistanceKm: campaign.individualTargetKm,
                            totalPoints: campaign.userPoints,
                            isGoalCompleted: m.isAchieved,
                          );
                        },
                        child: Container(
          ...
          child: campaign.isJoined
              ...
              : ElevatedButton.icon(
                  ...
                  onPressed: () async {
                    ...
                    if (ok && mounted) {
                      await CelebrationDialog.showCampaignJoined(
                        context,
                        campaign: campaign,
                        bonusPoints: 50,
                      );
