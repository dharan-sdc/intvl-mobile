  ...
  Future<void> _loadLeaderboard() async {
    ...
    try {
      ...
      if (mounted) {
        setState(() {
          _isLoading = false;
          _errorMessage = 'Unable to load leaderboard. Please check your connection and try again.';
        });
      }
    }
  }
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          // Main Standings List or Loading or Error
          Expanded(
            child: _isLoading
                ? const Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 16),
                        Text('Loading standings...', style: TextStyle(color: Colors.grey, fontSize: 13)),
                      ],
                    ),
                  )
                : lb == null || _errorMessage != null
                    ? Center(
                        child: Padding(
                          ...
                          child: Column(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              Icon(Icons.leaderboard_outlined, color: Colors.grey.shade400, size: 54),
                              ...
                              Text(
                                _errorMessage ?? 'Unable to retrieve leaderboard standings.',
