...
class _MyCampaignDashboardScreenState extends State<MyCampaignDashboardScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final targetDist = dashboard.targetDistanceKm > 0 ? dashboard.targetDistanceKm : 30.0;
          ...
          children: [
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text(
                        '/ ${targetDist.toStringAsFixed(1)} KM',
            ...
            if (dashboard.transactions.isEmpty)
              Container(
                ...
                child: const Text('No point transactions recorded yet.', style: TextStyle(color: Colors.grey, fontSize: 12)),
              )
            else
